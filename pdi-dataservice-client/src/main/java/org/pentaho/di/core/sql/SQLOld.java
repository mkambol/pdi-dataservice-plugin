...
public class SQLOld {
   ...
   */
  public SQLOld( String sqlString ) throws KettleSQLException {
  ...
  public void parse( RowMetaInterface rowMeta ) throws KettleSQLException {
    ...
    //SqlNode queryNode = calciteParse().orElseThrow( () -> new KettleSQLException() );
  ...
  private Optional<SqlNode> calciteParse() {
    SqlParser parser = SqlParser.create( sqlString );
    try {
      return Optional.of( parser.parseQuery() );
